            ...
            <li>
                <div class="pdoc-panel text-center">
                    ...
                    <?php
                     if(isset($proposal_no))
                      {
                       $pricing_costing = DB::table('projects')->join('project_cost_breakdowns','projects.id','=','project_cost_breakdowns.project_id')
                                                              ->select('projects.proposal_no')
                                                              ->where('projects.proposal_no',$proposal_no)
                                                              ->take(1)
                                                              ->get();
                    ...
                    ?>
                       @if(isset($proposal_no) && !empty($proposal_no) && sizeof($pricing_costing)==1) 
