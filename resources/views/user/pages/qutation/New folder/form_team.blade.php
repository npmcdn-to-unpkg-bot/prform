<ul class="list-unstyled inline-form-field clearfix">
    <li>
        ...
        <select name="sales_person_id" class="form-control select-styled stk2">
    ...
    <li>
        ...
        <select name="project_manager_id" class="form-control select-styled stk2">
    ...
    <li>
        ...
        <select name="designer_id" class="form-control select-styled stk2">
    ...
    <li>
        ...
        <select name="tech_support_id" class="form-control select-styled stk2">
    ...
    <li>
        ...
        <select id="developing_team_id" class="form-control select-styled stk2">
